...
import RefugeCardSkeleton from './components/RefugeCardSkeleton';
import RefugeList from './components/RefugeList';
              ...
              <div style={{ flex: 1, overflow: 'hidden', padding: '0 1.5rem 1.5rem' }}>
                {loading ? (
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                    {[...Array(5)].map((_, i) => (
                      <RefugeCardSkeleton key={i} layout="list" />
                    ))}
                  </div>
                ) : panelMode === 'expanded' && viewMode === 'grid' ? (
                  <div style={{
                    display: 'grid',
                  ...
                  <RefugeList
                    refuges={displayedRefuges}
                    onSelectRefuge={setSelectedRefuge}
                    onHoverRefuge={setHoveredRefugeId}
                    onHoverEndRefuge={() => setHoveredRefugeId(null)}
                    likedRefuges={likedRefuges}
                    starredRefuges={starredRefuges}
                    dislikedRefuges={dislikedRefuges}
